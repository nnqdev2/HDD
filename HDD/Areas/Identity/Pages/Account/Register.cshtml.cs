...
namespace HDD.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            var result = _hddDataService.IsIncomingSecondaryOwner(email);
            return new JsonResult(result);
        }
        public JsonResult OnPostCheckVINPlateRegisteredZip(string vin, string plate, string registeredZip)
        {
            //string result = vin + plate + registeredZip;
            //return new JsonResult(result);
            var result = _hddDataService.IsIncomingPrimaryOwner(Input.VIN, Input.Plate, Input.RegisteredZip);
            if (!result)
            {
